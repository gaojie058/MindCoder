  ...
  return (
    ...
    >
      <div className="flex flex-col mb-4 gap-4">
        ...
        {/* Disclaimer */}
        <div className="bg-gray-50 border-l-3 border-gray-300 px-3 py-2 mb-4 text-[11px] text-gray-500">
          ⚠️ AI-assisted analysis. Codes and themes were generated by LLM and reviewed by the researcher. Treat as reference, not definitive findings.
        </div>
