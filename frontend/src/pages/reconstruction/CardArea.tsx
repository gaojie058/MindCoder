  ...
  return (
    <>
      <div className="w-full h-full flex flex-col bg-[#FFFBF9]">
        {/* Stats Bar (with step name) + Trash + Search */}
        <div className="w-full px-4 py-2 flex items-center gap-2 bg-[#FFF3EE] border-b border-[#CB9180]/10 flex-shrink-0 text-xs">
          <span className="font-semibold text-[#CB9180] text-sm font-zen mr-1 shrink-0">Open Coding</span>
          <span className="text-[#CB9180]/40">|</span>
          {([
